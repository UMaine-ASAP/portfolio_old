...
CREATE TABLE `REPO_Media` (
  ...
  `creator_user_id` INTEGER NOT NULL,
  `owner_group_id` INTEGER NULL DEFAULT NULL,
...
ALTER TABLE `REPO_Colleges` ADD FOREIGN KEY (owner_group_id) REFERENCES `AUTH_Groups` (`group_id`);

ALTER TABLE `REPO_Departments` ADD FOREIGN KEY (college_id) REFERENCES `REPO_Colleges` (`college_id`);
ALTER TABLE `REPO_Departments` ADD FOREIGN KEY (owner_group_id) REFERENCES `AUTH_Groups` (`group_id`);

ALTER TABLE `REPO_Classes` ADD FOREIGN KEY (dept_id) REFERENCES `REPO_Departments` (`dept_id`);
ALTER TABLE `REPO_Classes` ADD FOREIGN KEY (owner_group_id) REFERENCES `AUTH_Groups` (`group_id`);

ALTER TABLE `REPO_Sections` ADD FOREIGN KEY (class_id) REFERENCES `REPO_Classes` (`class_id`);
ALTER TABLE `REPO_Sections` ADD FOREIGN KEY (group_id) REFERENCES `AUTH_Groups` (`group_id`);
ALTER TABLE `REPO_Sections` ADD FOREIGN KEY (day_sched) REFERENCES `REPO_Day_schedules` (`sched_id`);
ALTER TABLE `REPO_Sections` ADD FOREIGN KEY (owner_group_id) REFERENCES `AUTH_Groups` (`group_id`);
...
ALTER TABLE `REPO_Media` ADD FOREIGN KEY (owner_group_id) REFERENCES `AUTH_Groups` (`group_id`);
